      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-white mb-6 text-center md:text-left">
              Treine novas línguas com chats de Inteligência Artificial.
              Personalizado para suas necessidades de aprendizado.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-blue-300 pt-6 text-center">
          ...
          <p className="text-blue-700 mt-1">
            Contato:{" "}
            <a
              href="mailto:contato@wannatalk.com"
              className="underline hover:text-blue-900 transition"
            >
              contato@wannatalk.com
            </a>
          </p>
        </div>
      </div>
