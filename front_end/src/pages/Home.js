        ...
        <div className="flex-1 px-4 py-12">
          ...
          <section className="flex w-full max-w-4xl mx-auto mb-12 principal">
            <div className="principal-1">
              <h2 className="text-3xl font-extrabold text-gray-800 mb-6 text-center">
                Treinar <mark className="text-blue-500">novas línguas</mark> em diversas situações!
              </h2>
              <button
          ...
          <div className="sessao-bandeiras">
            <section className="bandeiras">
              <div>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Flag_of_the_United_Kingdom_%283-5%29.svg/255px-Flag_of_the_United_Kingdom_%283-5%29.svg.png" alt="Inglês" />
                <p>Inglês</p>
              </div>
              <div>
                <img src="https://static.mundoeducacao.uol.com.br/mundoeducacao/2022/01/bandeira-da-espanha.jpg" alt="Espanhol" />
                <p>Espanhol</p>
              </div>
              <div>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Flag_of_France_%281794%E2%80%931815%2C_1830%E2%80%931974%29.svg/1200px-Flag_of_France_%281794%E2%80%931815%2C_1830%E2%80%931974%29.svg.png" alt="Francês" />
                <p>Francês</p>
              </div>
              <div>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Flag_of_Germany.svg/255px-Flag_of_Germany.svg.png" alt="Alemão" />
                <p>Alemão</p>
              </div>
              <div>
                <img src="https://upload.wikimedia.org/wikipedia/commons/0/03/Flag_of_Italy.svg" alt="Italiano" />
                <p>Italiano</p>
              </div>
            </section>
          </div>
          ...
          <section className="w-full max-w-4xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Saber Mais</h2>
            <Slider {...settings}>
